...
export default function EnrollUser() {
    ...
    const fetchUserDetails = async () => {
        try {
            ...
            const response = await agentService.getOnboardedUsers({ search: userId });
    ...
    const fetchEnrolledServices = async () => {
        try {
            ...
            // const response = await agentService.getUserEnrollments(userId);
    ...
    const handlePaymentSuccess = (data: { case: any; payment: any }) => {
        // This won't be called anymore since PaymentDialog redirects
    ...
    useEffect(() => {
        ...
        if (paymentSuccess === 'true') {
            // Refresh enrollment history after successful payment
            fetchEnrolledServices();
            // Clean up URL
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                <Button variant="ghost" size="icon" onClick={() => navigate("/agent/users")}>
