...
export default function EnrollmentReceipt() {
    ...
    const fetchReceipt = async () => {
        try {
            setLoading(true);
            const response = await agentService.getEnrollmentReceipt(caseId!);
            if (response.success) {
                setReceipt(response.data);
            } else {
                toast.error(response.message || "Failed to fetch receipt");
                navigate("/agent/enrollment-history");
            }
        } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-muted/30 p-4 md:p-8">
            ...
            <div className="max-w-4xl mx-auto mb-4 flex gap-2 print:hidden">
                <Button variant="outline" onClick={() => navigate("/agent/enrollment-history")}>
            ...
            <Card className="max-w-4xl mx-auto shadow-lg print:shadow-none">
                <CardContent className="p-8 md:p-12">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-primary mb-2">Shree Laxminarayan Trademark Company</h1>
