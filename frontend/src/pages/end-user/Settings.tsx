...
import { User, Mail, Phone, Lock, Bell, Palette, Shield, UserX, Info } from "lucide-react";
import { toast } from "sonner";

export default function EndUserSettings() {
    const { user } = useAuth();
                ...
                <TabsContent value="notifications">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure how you receive case and payment notifications
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Alert>
                ...
                <TabsContent value="privacy">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Manage your data sharing and account deletion preferences
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Alert>
                                <Info className="h-4 w-4" />
                                <AlertDescription>
                                    <strong>Coming Soon!</strong> Data privacy settings (data download, account deletion, marketing preferences) will be available in a future update.
                                </AlertDescription>
                            </Alert>
                        </CardContent>
                    </Card>
