...
export default function EnrollmentHistory() {
    ...
    const fetchServices = async () => {
        try {
            ...
            // associateService.getServices returns AxiosResponse directly
    ...
    const fetchEnrollments = async () => {
        try {
            setLoading(true);
            const response = await associateService.getEnrollmentHistory({
    ...
    const handleViewReceipt = (caseId: string) => {
        navigate(`/associate/receipt/${caseId}`);
    };
