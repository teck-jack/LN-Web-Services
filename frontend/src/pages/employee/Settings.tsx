...
import { User, Mail, Phone, Lock, Bell, Palette, Shield, Briefcase, Info } from "lucide-react";
                ...
                <TabsContent value="notifications">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure how you receive case and system notifications
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Alert>
                ...
                <TabsContent value="work">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure your working hours and case preferences
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Alert>
                                <Info className="h-4 w-4" />
                                <AlertDescription>
                                    <strong>Coming Soon!</strong> Work preferences (working hours, availability status, case load preferences) will be available in a future update.
                                </AlertDescription>
                            </Alert>
                        </CardContent>
                    </Card>
