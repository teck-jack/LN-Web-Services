                ...
                <TabsContent value="advanced">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Admin-specific configuration and preferences
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Alert>
                                <Info className="h-4 w-4" />
                                <AlertDescription>
                                    <strong>Coming Soon!</strong> Advanced admin settings (case assignment rules, system notifications, data retention) will be available in a future update.
                                </AlertDescription>
                            </Alert>
                        </CardContent>
                    </Card>
